...
<main id="contenu" class="conteneur grid gap-8 py-8 lg:grid-cols-[240px_minmax(0,1fr)] lg:gap-x-16 lg:py-14">
  ...
  <nav class="lg:sticky lg:top-8 lg:row-start-2 lg:self-start" aria-labelledby="titre-sommaire">
    ...
    <ol class="mt-3 flex flex-col gap-2 border-l border-line pl-4 text-sm text-text-2">
          <li><a class="cible hover:text-primary-ink" href="#quelles-donnees-sont-collectees">Quelles données sont collectées</a></li>
          <li><a class="cible hover:text-primary-ink" href="#pourquoi-ces-donnees">Pourquoi ces données</a></li>
          <li><a class="cible hover:text-primary-ink" href="#combien-de-temps-sont-elles-conservees">Combien de temps sont-elles conservées</a></li>
          <li><a class="cible hover:text-primary-ink" href="#ce-qui-est-conserve-malgre-la-suppression">Ce qui est conservé malgré la suppression</a></li>
          <li><a class="cible hover:text-primary-ink" href="#comment-demander-la-suppression">Comment demander la suppression</a></li>
    </ol>
  </nav>
