        ...
        <?php foreach ($produits as $i => $produit): ?>
          ...
          <li class="produit scroll-mt-20" id="produit-<?= $produit_id ?>">
            ...
            <details class="border-t border-line px-3 text-xs">
              ...
              <input type="text" readonly id="lien-input-<?= $produit_id ?>" value="<?= e($lien_affiliation) ?>" class="mb-3 w-full rounded border border-line bg-surface-2 px-2 py-3 font-mono text-base text-text-2 sm:text-xs">
